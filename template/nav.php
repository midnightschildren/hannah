...
<ul>
<li class="grid-3"><a href="about-hannah.php" id="nav-about">ABOUT</a></li>
...
<li class="grid-3"><a href="http://blog.hannahsowd.com" target="_blank" id="nav-blog">READ HANNAH'S BLOG</a></li>
