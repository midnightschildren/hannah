...
<form class="editor" action="" method="post" name="post">
...
<textarea class="block_editor" id="area2" name="message" rows="10" cols="35" wrap="virtual" style="width:450px"></textarea>
